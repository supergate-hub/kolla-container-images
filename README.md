...
| Input | Contract |
| --- | --- |
| `operation` | `plan` (default; render and validate only, with no image build or registry mutation) or `publish` (build and publish from `main` after environment approval) |
